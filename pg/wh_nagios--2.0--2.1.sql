...
ALTER TABLE wh_nagios.hub ALTER COLUMN rolname TYPE text;

ALTER TABLE wh_nagios.hub_reject ALTER COLUMN rolname TYPE text;

ALTER TABLE wh_nagios.metrics RENAME CONSTRAINT fk_wh_nagios_metrics_wh_nagios_services TO metrics_id_service_fkey;

ALTER TABLE wh_nagios.series RENAME CONSTRAINT fk_wh_nagios_series_series TO series_id_graph_fkey;
ALTER TABLE wh_nagios.series RENAME CONSTRAINT fk_wh_nagios_series_wh_nagios_metrics TO series_id_metric_fkey;

ALTER INDEX wh_nagios.idx_wh_nagios_services_id_server_service RENAME TO services_id_server_service_key;
ALTER TABLE wh_nagios.services ADD UNIQUE USING INDEX services_id_server_service_key;
ALTER TABLE wh_nagios.services RENAME CONSTRAINT wh_nagios_services_id_server_fk TO services_id_server_fkey;
...
DROP FUNCTION delete_metrics(bigint[]);
...
DROP FUNCTION wh_nagios.delete_services(bigint[]);
...
DROP FUNCTION wh_nagios.grant_service(bigint, name);
...
DROP FUNCTION wh_nagios.revoke_dispatcher(name);
...
DROP FUNCTION wh_nagios.update_services_validity(interval, bigint[]);
